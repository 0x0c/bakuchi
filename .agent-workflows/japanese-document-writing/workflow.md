<!--
このスキルは Bajutsu プロジェクト (https://github.com/bajutsu-e2e/bajutsu) から
Apache License 2.0 のもとで借用し、bakuchi 向けに改変したものです。
Copyright 2026 Akira Matsuda
ライセンス本文は ../LICENSE、帰属表示は ../NOTICE を参照してください。

Bajutsu 版は k16shikano 氏の gist を元にしています。
...
文書の種別で文体を選ぶ。このリポジトリのロードマップ項目（`roadmaps/BK-*/*-ja.md`）は、
