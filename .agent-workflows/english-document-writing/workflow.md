...
This skill is the English layer of bakuchi's prose norm. It holds the mechanics that only English
...
The gated floor is the mechanical one: the file's shape (`tools/check_roadmap_format.py`) and its
typography (textlint).
