...
[docs/09-roadmap-ja.md](docs/09-roadmap-ja.md) を出典に、フェーズのタイムライン（最短・最長の幅つき）、
各フェーズの成果物と「意図的にやらないこと」、領域ごとのケイパビリティ導入マップ、
[roadmaps/](roadmaps/) の BK 項目をフェーズに紐づけた一覧を表示する。
