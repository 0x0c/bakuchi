...
export const DOCS = [
  { file: 'docs/09-roadmap.md', title: '09. ロードマップ', desc: '段階的構築計画（Phase 0〜4）' },
  ...
  { file: 'docs/04-client-sdk.md', title: '04. クライアント SDK', desc: 'API と評価モデル' },
  ...
  { file: 'docs/07-statistics.md', title: '07. 統計設計', desc: 'SRM、CUPED、逐次検定' },
